...
mongoose.connect(
  "mongodb://hci:123@cluster0-shard-00-00.2792g.mongodb.net:27017,cluster0-shard-00-01.2792g.mongodb.net:27017,cluster0-shard-00-02.2792g.mongodb.net:27017/shopping?ssl=true&replicaSet=atlas-hxd69j-shard-0&authSource=admin&retryWrites=true&w=majority",
...
app.get("/samsungj7asset", (req, res) => {
  res.sendFile("public/3dmodels/mobiles/iphone.glb", { root: __dirname });
});
